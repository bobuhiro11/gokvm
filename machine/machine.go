...
func New(nCpus int) (*Machine, error) {
	...
	v := virtio.NewNet(virtioIRQCallback, virtioTxCallback, m.mem).(*virtio.Net)
	go func() {
		...
		for {
			...
			// pkt := []byte{0x33, 0x33, 0x0, 0x0, 0x0, 0x16, 0xbe, 0x2f, 0x2e, 0x9a, 0xc, 0xa7, 0x86, 0xdd, 0x60, 0x0, 0x0, 0x0, 0x0, 0x24, 0x0, 0x1, 0xfe, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xbc, 0x2f, 0x2e, 0xff, 0xfe, 0x9a, 0xc, 0xa7, 0xff, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x16, 0x3a, 0x0, 0x5, 0x2, 0x0, 0x0, 0x1, 0x0, 0x8f, 0x0, 0x6d, 0x57, 0x0, 0x0, 0x0, 0x1, 0x4, 0x0, 0x0, 0x0, 0xff, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0xff, 0x9a, 0xc, 0xa7}
			v.Rx(pkt)
		}
	}()
