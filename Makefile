...
run: initrd bzImage
	...
	go run . -p "console=ttyS0 earlyprintk=serial noapic noacpi notsc debug apic=debug show_lapic=all mitigations=off lapic maxcpus=2 dyndbg=\"file arch/x86/kernel/smpboot.c +plf\"" -c 2
